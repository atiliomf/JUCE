...
public:
    ...
    */
    ...
    /** Returns the number of millisecs since a fixed event (usually system startup).
        ...
        Being a 32-bit return value, it will of course wrap back to 0 after 2^32 milliseconds of
        uptime (about 49.7 days), so be careful to take that into account. If you need a 64-bit
        time, you can use currentTimeMillis() instead.
